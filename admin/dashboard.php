    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php"><strong>GEU Feedback System</strong></a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
								 ...
								 <li>
                                    <a href="dashboard.php?info=display_student"><i class="fa fa-eye"></i> Manage Student Information</a>
                                </li> 
...
<li><a href="dashboard.php?info=feedback_average"><i class="fa fa-eye"></i> Feedback Average Of Faculty</a></li>
		...
		<li>
			<a href="dashboard.php?info=contact"><i class="fa fa-eye"></i> Information From Contact Us</a>
		</li>
