		...
		@$page=  $_GET['page'];
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              <a href="http://www.geu.ac.in" target="_blank"><img src="1.JPG" width="200" height="150" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>GEU Official Website</h4>
                  <span class="text-muted">Go to the college's Website</span></a>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <a href="http://14.139.239.134/moodle/"><img src="2.jpg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>LMS GEU</h4>
                  <span class="text-muted">Go to GEU learning managment system moodle</span></a>
            </div>
              
              
              <div class="col-xs-6 col-sm-3 placeholder">
              <a href="http://www.geu.ac.in/why-geu/reputed-faculty/distinguished-faculties"><img src="4.jpg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Faculty</h4>
                  <span class="text-muted">Go to GEU Faculty</span></a>
            </div>
