	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<option>btechcs</option>
					<option>btechpe</option>
					<option>btechme</option>
					<option>btechce</option>
					</select>
					</td>
				</tr>
				...
				<tr>
					...
					Dancing<input value="playing" type="checkbox" name="hob[]"/>
					Playing<input value="playing" type="checkbox" name="hob[]"/>
                        Coding<input value="playing" type="checkbox" name="hob[]"/>
                        Other<input value="playing" type="checkbox" name="hob[]"/>
					</td>
				</tr>
